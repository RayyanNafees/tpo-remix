		...
		<div className="flex flex-col w-[100%] bg-[#F8F8FF] sm:p-[3vw] text-customBlack">
			<div className="flex flex-col-reverse gap-[6vw] sm:gap-0 justify-center items-center sm:flex-row sm:justify-between">
				...
				<div className=" w-[85%] sm:w-[45%] flex-col flex justify-center  ">
					{/* heading */}
					<div className="font-bold text-[6vw] sm:text-[3vw]">Why ZHCET?</div>

					<div className="text-[3vw] sm:text-[1.3vw] mt-[2vw] sm:mt-0 font-[400]">
						Discover the future leaders of your industry at ZHCET, where
						academic excellence meets real-world impact. Our commitment to
						innovation, industry partnerships, and a dynamic learning
						environment ensures that our graduates are equipped with the skills
						and knowledge to thrive in today's competitive landscape. Join us in
						shaping the future of technology and fostering a diverse community
						of talented individuals ready to make a difference in the world.
					</div>
				</div>
			</div>
