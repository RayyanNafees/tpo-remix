	...
	return (
		<>
			...
			<div className="hidden lg:flex w-[100%] bg-[#2C3E50] text-[12px] py-2  text-white  justify-end items-center gap-6 pr-5">
				...
				<div onClick={toggleDropdown} onKeyUp={toggleDropdown}>
					<button
						type="button"
						className="dropbtn text-white text-center flex items-center gap-1"
					>
				...
				<Link to="/login/admin">
					<button
						type="button"
						className="bg-[#A3D2CA] text-[#2C3E50] text-[10px] font-[500] px-3 py-[5px] rounded-[10px] flex gap-[2px]"
					>
			...
			<header className="p-2 bg-white md:p-1 flex  sm:flex-row justify-between items-center">
				<div className="flex">
					<div>
						<img src={Logo} className="w-[10vw] md:w-[6vw]" alt="img" />
					</div>
